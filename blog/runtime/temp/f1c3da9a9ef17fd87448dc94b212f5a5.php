<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/data/home/qxu1141810136/htdocs/blog/application/home/view/editor/article.html";i:1512716095;s:78:"/data/home/qxu1141810136/htdocs/blog/application/base/view/base/page_base.html";i:1517543935;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="article_list">
        ...
        <div class="bk-gray box-shadow radius content_list">
                ...
                <div class="operate">
                    <div class="read_sta">状态：<?php if($v['show'] == '0'): ?>公开<?php else: ?>仅自己可见<?php endif; ?></div>
                    <div class="operate_b">
                        <a href="/blog/home/editor/article_list/sign/<?php echo $v['id']; ?>"><i class="Hui-iconfont">&#xe725;</i>&nbsp;查看</a>
                        <a href="javascript:;" data-id="<?php echo $v['id']; ?>" data-show="<?php echo $v['show']; ?>" onclick="overt(this)">
                            <?php if($v['show'] == '1'): ?>
