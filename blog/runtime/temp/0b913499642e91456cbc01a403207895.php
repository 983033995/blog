<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"/data/home/qxu1141810136/htdocs/blog/application/home/view/index/editbanner.html";i:1511852825;s:78:"/data/home/qxu1141810136/htdocs/blog/application/base/view/base/page_base.html";i:1517543935;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form action="" method="" class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-3">
                <input type="text" class="input-text must" name="bg_img" id="bg_img" value="<?php echo $list['bg_img']; ?>" placeholder="选择背景图" readonly />
            </div>
        ...
        <div class="row cl preview" id="bg_image">
            ...
            <div class="formControls col-xs-8 col-sm-7">
                <img src="<?php echo $list['bg_img']; ?>" />
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>选择内容图：</label>
            <div class="formControls col-xs-8 col-sm-3">
                <input type="text" class="input-text must" name="present_img" id="present_img" value="<?php echo $list['present_img']; ?>" placeholder="选择内容图" readonly />
            </div>
        ...
        <div class="row cl preview" id="present_image">
            ...
            <div class="formControls col-xs-8 col-sm-4">
                <img src="<?php echo $list['present_img']; ?>" />
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="new_york" cols="" rows="" class="textarea must"  placeholder="轮播内容简介...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！"><?php echo $list['new_york']; ?></textarea>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-3">
                <input type="text" class="input-text must" value="<?php echo $list['sort']; ?>" placeholder="排序值" id="sort" name="sort">
            </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-3">
                <input type="text" class="input-text" value="<?php echo $list['link']; ?>" placeholder="链接地址" id="link" name="link">
            </div>
            <span>可不填</span>
        </div>
        <div class="row cl">
...
<input class="original" name="new_york_animate" type="hidden" value="<?php echo $list['new_york_animate']; ?>">
<input class="original" name="new_york_duration" type="hidden" value="<?php echo $list['new_york_duration']; ?>">
<input class="original" name="new_york_dealy" type="hidden" value="<?php echo $list['new_york_dealy']; ?>">
<input class="original" name="present_img_animate" type="hidden" value="<?php echo $list['present_img_animate']; ?>">
<input class="original" name="present_img_duration" type="hidden" value="<?php echo $list['present_img_duration']; ?>">
<input class="original" name="present_img_dealy" type="hidden" value="<?php echo $list['present_img_dealy']; ?>">
<input class="original" name="set_type" type="hidden" value="<?php echo $list['set_type']; ?>">
<input class="is_finish" type="hidden" value="<?php echo $list['is_finish']; ?>">
            ...
            editor.loadPlugin('image', function () {
                editor.plugin.imageDialog({
                    ...
                    clickFn: function (url, title, width, height, border, align) {
                        if(oldValue != "" && oldValue != "<?php echo $list['bg_img']; ?>"){                     //判断是否多次上传了图片，如果多次上传了则没上传一次都将之前上传的删除
                            $.ajax({
                                type: 'POST',
                                data: {path:oldValue},
        ...
        K('#image2').click(function () {
            ...
            editor.loadPlugin('image', function (mySize) {
                editor.plugin.imageDialog({
                    ...
                    clickFn: function (url, title, width, height, border, align) {
                        if(oldValue != "" && oldValue != "<?php echo $list['present_img']; ?>"){                 //判断是否多次上传了图片，如果多次上传了则没上传一次都将之前上传的删除
                            $.ajax({
                                type: 'POST',
                                data: {path:oldValue},
                                url: 'http://www.zhangheteng.com/blog/home/editor/deleteImg',
