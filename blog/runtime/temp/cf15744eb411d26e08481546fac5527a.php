<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"/data/home/qxu1141810136/htdocs/think_web/application/home/view/index/index.html";i:1509490594;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" onclick="location.reload()">ZHT后台测试系统</a>
			...
			<ul class="cl">
				<li><?php echo session('pid_name'); ?></li>
				<li class="dropDown dropDown_hover">
					<a href="#" class="dropDown_A"><?php echo session('user_name'); ?> <i class="Hui-iconfont">&#xe6d5;</i></a>
    ...
    <script type="text/javascript">
         /*个人信息*/
        function myselfinfo(){
            var self_info = '<div class="self_info"><div class="self_title">账号：</div><div class="self_emp"><?php echo session('user_name'); ?></div></div>' +
                            '<div class="self_info"><div class="self_title">身份：</div><div class="self_emp"><?php echo session('pid_name'); ?></div></div>' +
