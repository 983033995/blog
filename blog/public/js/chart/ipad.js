(function ($, window, document, undefined) {
    ...
    Ipad.prototype = {
        moveResize: function (handle, setLeft, setTop, lockX, lockY) {
            ...
            handle.bind('mousedown', function (ev) {
                ...
                $(document).bind('mousemove', function (ev) {
                    ...
                    function barDisplay() {
                        self.$ipadCont.css({height: self.$ipad.height() - self.$ipadTitle.height() - 70});
                    ...
                    if (self.$ipad.height() <= self.limitedHeight) {
                        ...
                        self.$ipadCont.css({height: self.limitedHeight - self.$ipadTitle.height() - 70});
        ...
        initalPad: function () {
            ...
            this.$ipadCont.css({height: this.opts.height - this.$ipadTitle.height() - 70});
